import { Component, OnInit, Host, OnDestroy, ElementRef, Renderer2 } from '@angular/core';
...
export class FooterComponent implements OnInit, OnDestroy {
  ...
  constructor(@Host() public content: IonContent, private el: ElementRef, private renderer: Renderer2) { }
