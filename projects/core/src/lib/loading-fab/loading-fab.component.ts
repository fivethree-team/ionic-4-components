...
export class FivLoadingFab implements OnInit {
  ...
  @Output() fivComplete: EventEmitter<FivLoadingFab> = new EventEmitter<
    FivLoadingFab
  >();
  @Output() fivRefresh: EventEmitter<FivLoadingFab> = new EventEmitter<
    FivLoadingFab
  >();
  @Output() fivHidden: EventEmitter<FivLoadingFab> = new EventEmitter<
    FivLoadingFab
  >();
  @Output() fivShow: EventEmitter<FivLoadingFab> = new EventEmitter<
    FivLoadingFab
  >();
  ...
  @HostBinding('class') get classes(): string {
    const verticalClass = !!this.vertical
      ? `fab-vertical-${this.vertical}`
      : '';
    const horizontalClass = !!this.horizontal
      ? `fab-horizontal-${this.horizontal}`
      : '';
